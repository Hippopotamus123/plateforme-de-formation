...
export class FormationComponent implements OnInit {
  ...
  constructor(private toast:NgToastService,private http: HttpClient,public _dialog: MatDialog,private cookieService: CookieService,private userService: UserService,private authService: AuthService) { }
